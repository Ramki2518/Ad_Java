...
public class DownloadInvoiceCopies {

    private static final String SERVER_URL = "https://dmsfn.drreddys.com/wsi/FNCEWS40MTOM";
    private static final String USERNAME = "svc-cm_usr";  //System.getenv("FILENET_USER"); // Use Environment Variables
    private static final String PASSWORD = "Drreddy$june@102021";  //System.getenv("FILENET_PASS"); // Secure Credentials
    //private static final String OUTPUT_DIRECTORY = "C:\\Users\\Vamsi.T\\Downloads\\TestFold";
    private static final String OUTPUT_DIRECTORY = "C:\\Users\\Ramki_Yerramsetti\\Desktop\\Eamils";
    ...
    private static void processDocument(ObjectStore store, String caseId, String outputDir) {
        ...
        try {
            // Construct Query
            String sqlQuery = "SELECT ID, DocumentTitle FROM BAW_Invoice WHERE DocumentTitle = '" + caseId + "'";  //BAW_Invoice
    ...
    private static void fetchAndSaveDocument(ObjectStore store, Id docId, String outputDir) {
        ...
        try {
            ...
            String fileName = document.get_Name() + ".pdf";
